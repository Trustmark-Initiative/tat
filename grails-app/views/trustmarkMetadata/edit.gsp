...
<html>
	<head>
		...
		<title>Edit Trustmark Metadata</title>
	...
	<body>
        ...
        <h1>Edit Trustmark Metadata</h1>
        <div class="pageSubsection text-muted">
            On this page, you can edit an existing Trustmark Metadata instance to use in the system when you issue/grant new
            Trustmarks.
        </div>
        ...
        <div class="pageContent">
            <g:form class="form-horizontal" name="editTrustmarkMetadataForm" method="POST" action="update">
                <g:hiddenField name="trustmarkMetadataId" id="trustmarkMetadataId" value="${command.trustmarkMetadataId}" />
        ...
        <script type="text/javascript">
                ...
                $.ajax({
                    ...
                    success: function(result, textStatus, jqXHR){
                        ...
                        if( EXISTING_CERTIFICATES && EXISTING_CERTIFICATES.length > 0 ) {
                            ...
                            html += '        <span id="selectedExistingCertificateTitle"><em>Select Certificate...</em></span> <span class="caret"></span>\n';
                            html += '    </button>\n'
            ...
            function setSigningCertificate(id) {
                ...
                $('#selectedExistingCertificateTitle').html(cert.distinguishedName);
