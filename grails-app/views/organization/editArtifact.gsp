...
<html>
	<head>
		...
		<title>Organization Edit Artifact</title>
	...
	<body>
        ...
        <h1>${command.organization.identifier ?: 'UNKNOWN'}: Edit artifact ${command.displayName}</h1>
        <div class="pageSubsection">
            This page allows you to edit an existing artifact for the organization '${command.organization.name}'.  This artifact
            is considered global for this organization, and will be displayed as a selection option for any assessment
            step required artifact drop down (assuming it is active).
        </div>
        ...
        <div class="pageContent">
            <form action="${createLink(controller:'organization', action:'updateArtifact', id: command.organization.identifier)}"
                    method="POST" class="form-horizontal" onsubmit="return validateForm()">

                <g:hiddenField name="existingArtifactId" id="existingArtifactId" value="${command?.existingArtifactId}" />
                ...
                <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                        ...
                        <a href="${createLink(controller:'organization', action: 'view', id: command.organization.identifier)}" class="btn btn-default">
                            Cancel
                        </a>
                    </div>
                </div>
