...
<html>
	<head>
		...
		<title>Overall Report Form</title>
	...
	<body>
        ...
        <h1><span class="glyphicon glyphicon-globe"></span> Overall Report</h1>
        ...
        <div class="pageContent" style="margin-top: 3em;">
            ...
            <g:form action="overallReport" method="POST" class="form-horizontal">
