...
<head>
    ...
    <title>Create Artifact for Step ${currentStepData.step.name} in ${assessment.assessmentName}</title>
...
<div class="row">
    <div class="col-md-9">
        ...
        <div class="pageSubsection">
            This page allows you to create an artifact for step ${currentStepData.step.name} in ${assessment.assessmentName}.
        </div>
    </div>
...
<div class="row" style="margin-top: 2em;">
    <div class="col-md-12">
        <g:form class="form-horizontal" name="createArtifactForm" method="POST" action="saveArtifact">
            ...
            <div class="form-group">
                ...
                <script type="text/javascript">
                    ...
                    function defaultRequiredArtifact(){
                        $('#requiredArtifactId').val('');

                        // if only one artifact in the list, set it as the selected choice in the dropdown
                        if (REQUIRED_ARTIFACT_DATA.length == 1) {
                            var current = REQUIRED_ARTIFACT_DATA[0];

                            // this updates the control text and updates the selection
                            setRequiredArtifact(current.id);
                        } else {
                            clearRequiredArtifact();
                        }
                    }
                ...
                <div class="col-sm-10">
                    <div>
                        <ul class="nav nav-pills">
                            <li id="artifactFilePillUpload" role="presentation" class="active"><a href="javascript:updateFileDisplay('newUpload');">Upload File</a></li>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        // checks to set the artifact definition default choice
        defaultRequiredArtifact();
    });
