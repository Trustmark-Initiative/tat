...
<html>
    ...
    <g:if test="${flash.message}">
        ...
        <h1>Assessment #${command?.assessmentId}, Step #${stepData.step.stepNumber}: Create substep</h1>
        ...
        <div class="pageContent">
            ...
            <form class="form-horizontal" method="POST"
                  action="${createLink(controller:'assessmentPerform', action: 'saveSubstep', id: command.assessmentId, params: [stepNumber: stepData.step.stepNumber])}">
